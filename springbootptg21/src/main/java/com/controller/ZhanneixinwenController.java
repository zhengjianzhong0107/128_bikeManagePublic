...
public class ZhanneixinwenController {
    ...
    public R info(@PathVariable("id") Long id){
		...
		zhanneixinwen.setClicknum(zhanneixinwen.getClicknum()+1);
		zhanneixinwen.setClicktime(new Date());
		zhanneixinwenService.updateById(zhanneixinwen);
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<ZhanneixinwenEntity> wrapper = new EntityWrapper<ZhanneixinwenEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = zhanneixinwenService.selectCount(wrapper);
    ...
    public R autoSort(@RequestParam Map<String, Object> params,ZhanneixinwenEntity zhanneixinwen, HttpServletRequest request,String pre){
        EntityWrapper<ZhanneixinwenEntity> ew = new EntityWrapper<ZhanneixinwenEntity>();
